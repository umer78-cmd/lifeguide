      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12 lg:px-16 pt-24 pb-12">
        ...
        <div className="text-center mb-24 md:mb-32">
          <p className="text-brand-stone font-serif text-2xl md:text-4xl italic tracking-normalr leading-snug max-w-4xl mx-auto">
            {t('footer.quote1')} <br className="hidden md:block" />
            {t('footer.quote2')}
          </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-16 mb-24">
          ...
          <div className="md:col-span-5 lg:col-span-6">
            ...
            >
              <span className="text-[10px] uppercase tracking-[0.2em] font-semibold">{t('footer.linkedin')}</span>
          ...
          <div className="md:col-span-7 lg:col-span-6 grid grid-cols-2 sm:grid-cols-3 gap-10">
            ...
            {/* Nav */}
            <div>
              <h4 className="text-[10px] uppercase tracking-[0.15em] text-stone-700 font-bold mb-8">{t('footer.navTitle')}</h4>
              <ul className="space-y-4">
                {[
                  { name: t('footer.navHome'), path: '/' },
                  { name: t('footer.navJourney'), path: '/journey' },
                  { name: t('footer.navCommunion'), path: '/#voices-of-change' },
                  { name: t('footer.navConnection'), path: '/connection' }
                ].map((link, i) => (
                  <li key={i}>
                    <Link 
                      to={link.path}
            ...
            {/* Access */}
            <div>
              <h4 className="text-[10px] uppercase tracking-[0.15em] text-stone-700 font-bold mb-8">{t('footer.accessTitle')}</h4>
              <ul className="space-y-4">
                {[
            ...
            <div className="col-span-2 sm:col-span-1">
              <h4 className="text-[10px] uppercase tracking-[0.15em] text-stone-700 font-bold mb-8">{t('footer.legalTitle')}</h4>
              <ul className="space-y-4">
        ...
        <div className="pt-10 border-t border-stone-200/80 flex flex-col md:flex-row justify-between items-center gap-8 text-stone-700 text-[10px] uppercase tracking-[0.2em]">
          ...
          <div className="flex items-center gap-2 flex-wrap justify-center font-medium">
            ...
            <span>{t('footer.designBy')} <a href="https://www.growthzecore.com/" target="_blank" rel="noopener noreferrer" className="text-brand-gold/60 hover:text-brand-gold transition-colors">Zecore</a></span>
          </div>
